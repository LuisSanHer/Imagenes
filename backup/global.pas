...
begin
     ...
     begin
          ...
          begin
              ...
              M2.M[i][j][0] := round(max(0.0,min(power( sumR,1.0/p),255.0)));
              M2.M[i][j][1] := round(max(0.0,min(power( sumG,1.0/p),255.0)));
              M2.M[i][j][2] := round(max(0.0,min(power( sumB,1.0/p),255.0)));
          end;
     end;
end;
