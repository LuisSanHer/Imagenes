    ...
    begin
        ...
        begin
            ...
            begin
              if j=0 then
              begin
                M2.M[a][b][0] := round((IM.M[i][j+1][0] + IM.M[i+1][j][0] + IM.M[i+1][j+1][0])/3.0);
                M2.M[a][b][1] := round((IM.M[i][j+1][1] + IM.M[i+1][j][1] + IM.M[i+1][j+1][1])/3.0);
                M2.M[a][b][2] := round((IM.M[i][j+1][2] + IM.M[i+1][j][2] + IM.M[i+1][j+1][2])/3.0);
              end
              else if j=IM.ancho-1 then
              begin
                M2.M[a][b][0] := round((IM.M[i][j-1][0] + IM.M[i+1][j][0] + IM.M[i+1][j-1][0])/3.0);
              ...
              begin
                M2.M[a][b][0] := round((IM.M[i][j-1][0] + IM.M[i][j+1][0] + IM.M[i+1][j][0] + IM.M[i+1][j+1][0] + IM.M[i+1][j-1][0])/5.0);
                M2.M[a][b][1] := round((IM.M[i][j-1][1] + IM.M[i][j+1][1] + IM.M[i+1][j][1] + IM.M[i+1][j+1][1] + IM.M[i+1][j-1][1])/5.0);
                M2.M[a][b][2] := round((IM.M[i][j-1][2] + IM.M[i][j+1][2] + IM.M[i+1][j][2] + IM.M[i+1][j+1][2] + IM.M[i+1][j-1][2])/5.0);
              end;
            end
            ...
            begin
              M2.M[a][b][0] := round((IM.M[i-1][j][0] + IM.M[i+1][j][0] + IM.M[i-1][j+1][0] + IM.M[i+1][j+1][0] + IM.M[i][j+1][0])/5.0);
              M2.M[a][b][1] := round((IM.M[i-1][j][1] + IM.M[i+1][j][1] + IM.M[i-1][j+1][1] + IM.M[i+1][j+1][1] + IM.M[i][j+1][1])/5.0);
              M2.M[a][b][2] := round((IM.M[i-1][j][2] + IM.M[i+1][j][2] + IM.M[i-1][j+1][2] + IM.M[i+1][j+1][2] + IM.M[i][j+1][2])/5.0);
            end
            else if j=IM.ancho-1 then
            begin
              M2.M[a][b][0] := round((IM.M[i-1][j][0] + IM.M[i+1][j][0] + IM.M[i-1][j-1][0] + IM.M[i+1][j-1][0] + IM.M[i][j-1][0])/5.0);
            ...
            begin
              M2.M[a][b][0] :=round((IM.M[i-1][j][0] + IM.M[i][j-1][0] + IM.M[i+1][j][0] + IM.M[i][j+1][0] + IM.M[i-1][j-1][0] + IM.M[i-1][j+1][0] + IM.M[i+1][j-1][0] + IM.M[i+1][j+1][0])/8.0);
              M2.M[a][b][1] :=round((IM.M[i-1][j][1] + IM.M[i][j-1][1] + IM.M[i+1][j][1] + IM.M[i][j+1][1] + IM.M[i-1][j-1][1] + IM.M[i-1][j+1][1] + IM.M[i+1][j-1][1] + IM.M[i+1][j+1][1])/8.0);
              M2.M[a][b][2] :=round((IM.M[i-1][j][2] + IM.M[i][j-1][2] + IM.M[i+1][j][2] + IM.M[i][j+1][2] + IM.M[i-1][j-1][2] + IM.M[i-1][j+1][2] + IM.M[i+1][j-1][2] + IM.M[i+1][j+1][2])/8.0);
            end;
        end;
    end;
  SetLength(IM.M, M2.alto, M2.ancho, 3);
